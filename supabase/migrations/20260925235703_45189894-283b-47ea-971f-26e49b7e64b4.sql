...
BEGIN
  ...
  RETURN true;
END $$;
REVOKE EXECUTE ON FUNCTION public.activate_subscription_by_id(uuid,numeric,text,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.activate_subscription_by_id(uuid,numeric,text,uuid) TO service_role;
DROP FUNCTION public.activate_subscription_by_id(uuid,numeric,text);